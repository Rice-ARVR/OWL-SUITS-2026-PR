        ...
        <div className={styles.container}>
            <div className={styles.joystickPad}>
                <div className={styles.dpad}>
                    <button className={`${styles.btn} ${styles.up}    ${up    ? styles.active : ""}`} aria-label="Up" />
                    <button className={`${styles.btn} ${styles.down}  ${down  ? styles.active : ""}`} aria-label="Down" />
                    <button className={`${styles.btn} ${styles.left}  ${left  ? styles.active : ""}`} aria-label="Left" />
                    <button className={`${styles.btn} ${styles.right} ${right ? styles.active : ""}`} aria-label="Right" />
                    <div
